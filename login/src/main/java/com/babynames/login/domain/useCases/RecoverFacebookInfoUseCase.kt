...
class RecoverFacebookInfoUseCase @Inject constructor(threadExecutor: ThreadExecutor, postExecutionThread: PostExecutionThread) : AbstractRecoverFacebookInfoUseCase(threadExecutor, postExecutionThread) {
